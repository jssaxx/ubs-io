# 前言<a name="ZH-CN_TOPIC_0000002485192104"></a>

**概述<a name="section4537382116410"></a>**

本文档描述了BoostIO对外提供的API接口信息，包括API接口参数解释和使用样例等。
...
# 介绍<a name="ZH-CN_TOPIC_0000002485192094"></a>

本文主要介绍BoostIO对外提供的API接口。

-   编程语言

    BoostIO主体使用C/C++语言开发，对外提供C API。

-   功能架构

    BoostIO结合JuiceFS实现计算侧分布式缓存，降低IO读写时延，提升端到端的整体性能。

-   API参考

    介绍应用开发过程中最常用和基础的API，建议使用BoostIO的开发者对这些API都有所了解。

-   错误码

    介绍BoostIO的错误码名称、取值及部分常见错误码的处理方法。

# API参考<a name="ZH-CN_TOPIC_0000002517312017"></a>
...
## BioInitialize<a name="ZH-CN_TOPIC_0000002485032142"></a>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p id="p1236917392541"><a name="p1236917392541"></a><a name="p1236917392541"></a>BoostIO初始化选项，详细解释参见<a href="#table0292135934712">表2</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<tbody><tr id="row14292359194714"><td class="cellrowborder" rowspan="10" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p id="p129255934713"><a name="p129255934713"></a><a name="p129255934713"></a>ClientOptionsConfig</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p id="p19329210105117"><a name="p19329210105117"></a><a name="p19329210105117"></a>logType</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p179831633186"><a name="p179831633186"></a><a name="p179831633186"></a>日志类型。</p>
...
<tr id="row829265924718"><td class="cellrowborder" valign="top" headers="mcps1.2.4.1.1 "><p id="p4292659154713"><a name="p4292659154713"></a><a name="p4292659154713"></a>logFilePath</p>
</td>
...
<tr id="row10747143312526"><td class="cellrowborder" valign="top" headers="mcps1.2.4.1.1 "><p id="p674733317526"><a name="p674733317526"></a><a name="p674733317526"></a>enable</p>
</td>
...
<tr id="row16366193618524"><td class="cellrowborder" valign="top" headers="mcps1.2.4.1.1 "><p id="p23665366522"><a name="p23665366522"></a><a name="p23665366522"></a>certificationPath</p>
</td>
...
<tr id="row12111239115215"><td class="cellrowborder" valign="top" headers="mcps1.2.4.1.1 "><p id="p151121439155210"><a name="p151121439155210"></a><a name="p151121439155210"></a>caCerPath</p>
</td>
...
<tr id="row1674005210522"><td class="cellrowborder" valign="top" headers="mcps1.2.4.1.1 "><p id="p197408529528"><a name="p197408529528"></a><a name="p197408529528"></a>caCrlPath</p>
</td>
...
<tr id="row17294459145218"><td class="cellrowborder" valign="top" headers="mcps1.2.4.1.1 "><p id="p12294859175213"><a name="p12294859175213"></a><a name="p12294859175213"></a>privateKeyPath</p>
</td>
...
<tr id="row1617875711528"><td class="cellrowborder" valign="top" headers="mcps1.2.4.1.1 "><p id="p161784573520"><a name="p161784573520"></a><a name="p161784573520"></a>privateKeyPassword</p>
</td>
...
## BioExit<a name="ZH-CN_TOPIC_0000002485192084"></a>

**函数定义<a name="section4349141610276"></a>**

BoostIO退出接口，使用者调用该接口退出BoostIO读写缓存服务。
...
## BioCreateCache<a name="ZH-CN_TOPIC_0000002517352049"></a>

**函数定义<a name="section4349141610276"></a>**

创建Cache实例接口，使用者根据实际应用场景选择合适的缓存策略和数据亲和策略来创建BoostIO Cache实例。
...
## BioGetCache<a name="ZH-CN_TOPIC_0000002517352025"></a>
...
## BioDestroyCache<a name="ZH-CN_TOPIC_0000002485192078"></a>
...
## BioCalcLocation<a name="ZH-CN_TOPIC_0000002485192082"></a>
...
<td class="cellrowborder" valign="top" width="80%" headers="mcps1.2.3.1.2 "><p id="p1927413479432"><a name="p1927413479432"></a><a name="p1927413479432"></a>BoostIO服务未就绪。</p>
</td>
</tr>
...
## BioPut<a name="ZH-CN_TOPIC_0000002485032130"></a>
...
## BioGet<a name="ZH-CN_TOPIC_0000002517312009"></a>
...
## BioDelete<a name="ZH-CN_TOPIC_0000002517312021"></a>
...
## BioLoad<a name="ZH-CN_TOPIC_0000002517312029"></a>
...
## BioListAll<a name="ZH-CN_TOPIC_0000002517352045"></a>
...
## BioFreeListResources<a name="ZH-CN_TOPIC_0000002517312025"></a>
...
## BioStat<a name="ZH-CN_TOPIC_0000002517352051"></a>
...
## BioNotifyUpgradePrepare<a name="ZH-CN_TOPIC_0000002517352037"></a>

**函数定义<a name="section4349141610276"></a>**

通知升级准备接口，使用者调用该接口后将停止BoostIO读写缓存服务，缓存数据逐渐淘汰到后端存储，后续前台IO直接写入后端存储中。
...
## BioNotifyUpgradeFinish<a name="ZH-CN_TOPIC_0000002485032118"></a>

**函数定义<a name="section4349141610276"></a>**

通知升级完成接口，使用者调用该接口后将重启BoostIO读写缓存服务，后续前台IO直接写入后端缓存中。
...
## BioCheckUpgradeReady<a name="ZH-CN_TOPIC_0000002485032114"></a>
...
## BioAllocCacheSpace<a name="ZH-CN_TOPIC_0000002485192090"></a>
...
<td class="cellrowborder" valign="top" width="79.39%" headers="mcps1.2.3.1.2 "><p id="p1927413479432"><a name="p1927413479432"></a><a name="p1927413479432"></a>BoostIO服务未就绪。</p>
</td>
</tr>
...
## BioPutWithCopyFree<a name="ZH-CN_TOPIC_0000002485032122"></a>
...
## BioReadHook<a name="ZH-CN_TOPIC_0000002485032138"></a>
...
## BioWriteHook<a name="ZH-CN_TOPIC_0000002517352041"></a>
...
## BioWriteCopyFreeHook<a name="ZH-CN_TOPIC_0000002485192108"></a>
...
## BioRegisterInterceptorRead<a name="ZH-CN_TOPIC_0000002517312013"></a>
...
## BioRegisterInterceptorWrite<a name="ZH-CN_TOPIC_0000002517352033"></a>
...
## BioRegisterInterceptorWriteCopyFree<a name="ZH-CN_TOPIC_0000002485192100"></a>
...
## BioConvertLocation<a name="ZH-CN_TOPIC_0000002485032126"></a>
...
<td class="cellrowborder" valign="top" width="76.42%" headers="mcps1.2.3.1.2 "><p id="p1927413479432"><a name="p1927413479432"></a><a name="p1927413479432"></a>BoostIO服务未就绪。</p>
</td>
</tr>
...
## BioShowCacheResource<a name="ZH-CN_TOPIC_0000002517312005"></a>
...
## BioFreeCacheResourcePtr<a name="ZH-CN_TOPIC_0000002517312031"></a>
...
## BioShowCacheHitRatio<a name="ZH-CN_TOPIC_0000002485032146"></a>
...
## BioFreeCacheHitPtr<a name="ZH-CN_TOPIC_0000002485192112"></a>
...
## BioAddDisk<a name="ZH-CN_TOPIC_0000002517352057"></a>
...
# 错误码<a name="ZH-CN_TOPIC_0000002517352029"></a>
