...
static inline void __dpax_list_splice(const struct list_head *list,
                struct list_head *prev,
                struct list_head *next)
{
...
* @retval NA
*/
static inline void dpax_list_splice(const struct list_head *list,
                    struct list_head *head)
{
    if (!dpax_list_empty(list))
        __dpax_list_splice(list, head, head->next);
}
...
* @retval NA
*/
static inline void dpax_list_splice_init(struct list_head *list,
        struct list_head *head)
{
     if (!dpax_list_empty(list)) {
         __dpax_list_splice(list, head, head->next);
...
* @retval NA
*/
static inline void dpax_list_splice_tail(struct list_head *list,
                    struct list_head *head)
{
    if (!dpax_list_empty(list))
        __dpax_list_splice(list, head->prev, head);
}
...
* @retval NA
*/
static inline void dpax_splice_tail_init(struct list_head *list,
                     struct list_head *head)
{
    if (!list_empty(list)) {
        __dpax_list_splice(list, head->prev, head);
