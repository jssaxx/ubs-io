...
UBS-IO产品的使用许可证，适用于木兰宽松许可证（[http://license.coscl.org.cn/MulanPSL2）](http://license.coscl.org.cn/MulanPSL2%EF%BC%89)，具体请参见主目录下LICENSE文件
UBS-IO文档doc目录下的文档，适用于Attribution-ShareAlike 4.0 International，具体请参见doc目录下LICENSE文件
