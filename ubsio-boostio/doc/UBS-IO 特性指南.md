...
3.  配置安装信息。
    ...
    **表 6**  BoostIO配置项
    ...
    <td class="cellrowborder" valign="top" headers="mcps1.2.7.1.2 "><p id="p1562216424418"><a name="p1562216424418"></a><a name="p1562216424418"></a>解密函数so路径。</p>
    </td>
    <td class="cellrowborder" valign="top" headers="mcps1.2.7.1.3 "><p id="p11514156227"><a name="p11514156227"></a><a name="p11514156227"></a>/path/libdecrypt.so</p>
    </td>
...
-   生成加密口令之前建议关闭系统历史记录功能。口令生成后可重新启用该功能。
    ...
    用户导入的私钥需要进行加密。私钥口令需要用户自行通过编写的加密函数进行加密生产文件，并提供解密函数对应的so。
...
<tr id="row9383193616272"><td class="cellrowborder" valign="top" width="30%" headers="mcps1.2.3.1.1 "><p id="zh-cn_topic_0000001821752165_p27965815164"><a name="zh-cn_topic_0000001821752165_p27965815164"></a><a name="zh-cn_topic_0000001821752165_p27965815164"></a>解密函数so文件</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001821752165_p77955861613"><a name="zh-cn_topic_0000001821752165_p77955861613"></a><a name="zh-cn_topic_0000001821752165_p77955861613"></a>需要程序dlopen的so</p>
</td>
</tr>
</tbody>
</table>
...
3.  创建Server目录，建议将新创建的目录权限设置为0700。
...
4.  <a name="zh-cn_topic_0000001775152198_li11431122010253"></a>将上述[表1](#zh-cn_topic_0000001775152198_table2936153410819)中需要的CA文件、Server端证书、Server端的证书对应的私钥文件、加密后的私钥口令放置在Server目录下。为了安全，建议将权限设置为0400。

    **图 1**  证书及私钥文件<a name="fig37637114228"></a>  
    ![](image/证书及私钥文件.png "证书及私钥文件")

5.  <a name="li82501632121914"></a>修改bio.conf配置文件，打开安全开关，将[4](#zh-cn_topic_0000001775152198_li11431122010253)中相关证书文件的路径写入到配置文件中的相应选项。
...
<tr id="row9383193616272"><td class="cellrowborder" valign="top" width="24.279999999999998%" headers="mcps1.2.3.1.1 "><p id="zh-cn_topic_0000001821752165_p27965815164"><a name="zh-cn_topic_0000001821752165_p27965815164"></a><a name="zh-cn_topic_0000001821752165_p27965815164"></a>解密函数so文件</p>
</td>
<td class="cellrowborder" valign="top" width="75.72%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001821752165_p77955861613"><a name="zh-cn_topic_0000001821752165_p77955861613"></a><a name="zh-cn_topic_0000001821752165_p77955861613"></a>需要程序dlopen的so</p>
</td>
</tr>
</tbody>
</table>

需要用户自行准备动态库, 并so所在路径传入配置文件`bio.net.tls.server.decrypter.lib.path`选项中
系统会尝试加载传入的动态库，并在其中查找名为`DecryptPassword`的函数。
解密函数的签名如下：
...
具体请参考test/tools/decrypt目录下Readme文件
