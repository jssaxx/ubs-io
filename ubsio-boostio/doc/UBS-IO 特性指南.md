...
UBS IO已经安装成功，需给予Server用户相应的权限读取下面文件。本章节以安装目录“/opt“为例进行描述。获取TLS认证需要的文件，如[表1](#zh-cn_topic_0000001775152198_table2936153410819)所示。
...
UBS IO已经安装成功，需给予Client用户相应的权限读取下面文件。本章节以安装目录/opt为例进行描述。首先获取TLS认证需要的文件，如[表1](#zh-cn_topic_0000001775152198_table2936153410819)所示。
