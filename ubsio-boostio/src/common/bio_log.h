...
#define BIOLOG_LEVEL_TRACE 0
#define BIOLOG_LEVEL_DEBUG 1
#define BIOLOG_LEVEL_INFO 2
#define BIOLOG_LEVEL_WARN 3
#define BIOLOG_LEVEL_ERROR 4
...
#define LOG_WARN(msg) BIO_LOG_INTERNAL(BIOLOG_LEVEL_WARN, BIO_LOG_FILENAME, __LINE__, __FUNCTION__, msg)
