...
void tp::SdkTp::Register() noexcept
{
    ...
    BIO_TP_REG(SDK_MIRROR_CHECK_PT_FAIL, "sdk mirror check pt failed, return BIO_CHECK_PT_FAIL",
               CommonTp::BoolValueCallback);
    ...
    BIO_TP_REG(SDK_BIO_AGENT_START_OP_FAIL, "sdk agent start op fail, return BIO_INNER_ERR",
               CommonTp::IntValueCallback);
    BIO_TP_REG(SDK_BIO_AGENT_LOAD_FUNC_FAIL, "sdk agent load func fail, return BIO_INNER_ERR",
               CommonTp::PointerValueCallback);
    BIO_TP_REG(SDK_BIO_MIRROR_SEND_SYNC_FAIL, "sdk mirror sendsync fail, return BIO_INNER_RETRY",
               CommonTp::IntValueCallback);
    BIO_TP_REG(SDK_BIO_NET_START_RPC_FAIL, "start net post rpc fail, return BIO_INNER_ERR", CommonTp::IntValueCallback);
    BIO_TP_REG(SDK_BIO_NET_START_CONNECT_FAIL, "net post connect fail, return BIO_INNER_ERR",
               CommonTp::IntValueCallback);
    BIO_TP_REG(SDK_MIRROR_PUT_RECV_FAIL, "sdk mirror recv put request failed, return BIO_INNER_RETRY",
               CommonTp::IntValueCallback);
    BIO_TP_REG(SDK_MIRROR_GET_RECV_FAIL, "sdk mirror recv get request failed, return BIO_INNER_RETRY",
               CommonTp::IntValueCallback);
    BIO_TP_REG(SDK_MIRROR_DELETE_RECV_FAIL, "sdk mirror recv delete request failed, return BIO_INNER_RETRY",
               CommonTp::IntValueCallback);
    BIO_TP_REG(SDK_MIRROR_ADD_DISK_RECV_FAIL, "sdk mirror recv add disk request failed, return BIO_INNER_RETRY",
               CommonTp::IntValueCallback);
    BIO_TP_REG(SDK_MIRROR_LOAD_RECV_FAIL, "sdk mirror recv load request failed, return BIO_INNER_RETRY",
               CommonTp::IntValueCallback);
    BIO_TP_REG(SDK_MIRROR_STAT_RECV_FAIL, "sdk mirror recv stat request failed, return BIO_INNER_RETRY",
               CommonTp::IntValueCallback);
    BIO_TP_REG(SDK_MIRROR_LIST_RECV_FAIL, "sdk mirror recv list request failed, return BIO_INNER_RETRY",
               CommonTp::IntValueCallback);
    BIO_TP_REG(SDK_MIRROR_NOTIFY_UPDATE_RECV_FAIL, "sdk mirror notify update request failed, return BIO_INNER_RETRY",
               CommonTp::IntValueCallback);
    BIO_TP_REG(SDK_MIRROR_CHECK_UPDATE_RECV_FAIL, "sdk mirror check update request failed, return BIO_INNER_RETRY",
               CommonTp::IntValueCallback);
    ...
    BIO_TP_REG(SDK_MIRROR_ALLOC_PUT_OFFSET_FAIL, "sdk mirror alloc put offset fail, return BIO_INNER_RETRY",
               CommonTp::IntValueCallback);
    ...
    BIO_TP_REG(SDK_CLIENT_GET_CEPH_STAT_SIZE, "sdk mirror client get ceph stat size unequit zero",
               CommonTp::IntValueCallback);
    ...
    BIO_TP_REG(SDK_CLIENT_GET_UNDERFS_CONFIG_PASS_SYNC_CALL, "get underfs config pass sync call",
    ...
    BIO_TP_REG(SDK_REQUEST_IPC_OPCODE_EXCEED, "sdk request IPC opcode exceed 256, return BIO_ERR",
               CommonTp::IntValueCallback);
}
