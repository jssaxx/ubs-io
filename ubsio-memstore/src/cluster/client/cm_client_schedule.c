...
#define CM_CLIENT_THREADPOOL_NUM (1)
#define CM_CLIENT_THREADPOOL_NAME "cm_client_schedule"
...
{
    uint16_t index = poolId / CM_CLIENT_THREADPOOL_NUM;
...
int32_t CmClientScheduleInit(void)
{
    ...
    CM_LOGINFO("Cm client schedule init succeed.");
    return RETURN_OK;
}
